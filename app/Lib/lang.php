...
$cm_texts['en_US'] = array(
  ...
  'ct.co_petition.duplicate.check' => 'CO Petition Duplicate Check',
...
//    ServerEnum::LdapServer   => 'LDAP',
  ...
  'op.match.add.confirm' => 'Are you sure you wish to add a new CO Person record?',
  'op.match.merge' => 'Merge',
  'op.match.new' =>   'Assign a new Reference Identifier',
  'op.match.select.confirm' => 'Do you want to merge the new identity with this existing identity?',
  'op.menu' =>        'Menu',
  'op.move' =>        'Move',
  'op.msg.tpl.test' => 'Test Template',
