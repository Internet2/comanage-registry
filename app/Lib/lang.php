...
(@NOTIFICATION_URL)',
  ...
  'fd.server.http.ssl_allow_self_signed'      => 'ssl_allow_self_signed',
  'fd.server.http.ssl_allow_self_signed.desc' => 'Allow self-signed certificates.',
  'fd.server.http.ssl_verify_host'            => 'ssl_verify_host',
  'fd.server.http.ssl_verify_host.desc'       => 'Require verification of hostname.',
  'fd.server.http.ssl_verify_peer'            => 'ssl_verify_peer',
  'fd.server.http.ssl_verify_peer.desc'       => 'Require verification of SSL certificate.',
  'fd.server.http.ssl_verify_peer_name'       => 'ssl_verify_peer_name',
  'fd.server.http.ssl_verify_peer_name.desc'  => 'Require verification of peer name.',
  'fd.set' =>         'Set',
  'fd.set.not' =>     'Not Set',
  'fd.sorid' =>       'Source Key',
  'fd.sort.by' =>     'Sort By',
