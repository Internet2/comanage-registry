...
$cm_texts['en_US'] = array(
  ...
  'ct.kdc_servers.1' =>         'KDC Server',
  'ct.kdc_servers.pl' =>        'KDC Servers',
...
//    ServerEnum::LdapServer   => 'LDAP',
  ...
  'er.javascript.copy' => 'Could not copy.',
  'er.javascript.requires.https' => 'This feature requires HTTPS.',
  ...
  'er.jb.txn' =>      'Open transaction detected at Job termination, issuing rollback',
  'er.jb.txn.fail' => 'Job failed due to open transaction',
  'er.label.inuse.by' => 'Configuration Label "%1$s" is used by "%2$s."',
  ...
  'er.mfa.login' =>  'MFA is required to access Registry',
  ...
  'er.prov.job.count' => 'ProvisioningCount record failed to save',
  ...
  'fd.code' =>        'Code',
  'fd.color' =>       'Color',
  'fd.color.desc' =>  'Color associated to the label value.',
  'fd.comment' =>     'Comment',
  'fd.comparison' =>  'Comparison',
  'fd.conditions' =>  'Conditions',
  'fd.copy-a' =>      'Copy of %1$s',
  'fd.cou' =>         'COU',
  'fd.cou.configuration_labels.desc' =>  'Comma separated list of <a href="https://spaces.at.internet2.edu/display/COmanage/Configuration+Labels">Labels</a>',
  'fd.cou.list' =>    'COU list',
  'fd.cou.nopar'  =>  'No COUs are available to be assigned parent',
  'fd.cou-a' =>       '%1$s COU',
  'fd.co_dashboard_widgets.footer' =>  'Widget Footer',
  ...
  'fd.ea.attr.filter' => 'Filter Attributes By Configuration Label',
  'fd.ea.attr.filter.desc' => 'If set, only Attributes with this Configuration label will be made available in the Petition Form',
  ...
  'fd.el.gr.approvers' => 'Approvers Group',
  'fd.el.gr.approvers.desc' => 'Members of this group will be able to process pending petitions',
  ...
  'fd.env_mfa' =>     'MFA Assertion Indicator',
  'fd.env_mfa.desc' => 'Name of the Environment Variable that indicates if MFA was asserted at login; if set, MFA must be asserted for most access to Registry',
  'fd.env_mfa_value' => 'MFA Assertion Indicator Value',
  'fd.env_mfa_value.desc' => 'Expected value of the Environment Variable to indicate that MFA as asserted at login',
  ...
  'fd.job.max_retry.desc' => 'If the job fails, it will automatically be rescheduled up to %1$s time(s)',
...
//  'fd.os.source_key' => 'Source Key',
  ...
  'fd.pi.sync.attributes.placeholder' => 'Select Attributes',
  ...
  'fd.prov.max_retry.desc' => 'After the provisioning fails retry up to the specified number of times. If set to 0 (zero) it will retry indefinitely',
  ...
  'fd.server.kdc.admin_hostname' => 'Admin Server Hostname',
  'fd.server.kdc.admin_hostname.desc' => 'kadmin server hostname if different than KDC hostname',
  'fd.server.kdc.admin_port' => 'Admin Server Port',
  'fd.server.kdc.admin_port.desc' => 'kadmin server port if different than default port 749',
  'fd.server.kdc.realm' => 'Realm',
  'fd.server.kdc.principal' => 'Principal',
  'fd.server.kdc.principal.desc' => 'Principal used to connect to admin server',
  'fd.server.kdc.keytab' => 'Keytab File Path',
  'fd.server.kdc.keytab.desc' => 'Keytab file must be readable by the web server user',
  ...
  'fd.sor_label.desc' => 'Label used by ID Match server, see <a href="https://spaces.at.internet2.edu/display/COmanage/Integrating+With+ID+Match#IntegratingWithIDMatch-SystemofRecordLabelssorlabel">Integrating With ID Match</a> for details. May also be used by plugins as needed.',
  'fd.sort.by' =>     'Sort By',
  'fd.source' =>      'Source',
  'fd.sponsor' =>     'Sponsor',
  ...
  'me.menu.filters'    => 'Filters',
  'me.menu.filters.close' => 'Close filters form',
  'me.menu.filters.form' => 'Filters form',
  ...
  'op.not.manual-a' => '\'%1$s\': manual mode not enabled',
  ...
  'op.people.picker.placeholder' => 'enter name, email address, or identifier',
  ...
  'rs.co.empty' =>    'There are no people in this CO.',
  ...
  'rs.search.too.large' => 'To view CO People, filter the listing using the available filters above.',
  ...
  'se.mfareset.done' =>   'Removed MFA configuration for access to Registry',
