...
//    ServerEnum::LdapServer   => 'LDAP',
  ...
  'fd.job.max_retry.desc' => 'If the job fails, it will automatically be rescheduled for <bold>"%1$s" number</bold> of times. (To stop retrying, simply cancel this job.)',
  ...
  'fd.prov.max_retry.desc' => 'After the provisioning fails it will automatically retry for XX times. If set to 0 (zero) it will retry for infinite times',
