<?php
/**
 * COmanage Registry CO Identifier Assignments Order View
 *
 ...
 */
  ...
  $this->Html->addCrumb(_txt('op.order-a', array(_txt('ct.co_identifier_assignments.pl'))));
  ...
  $(function() {
    ...
    $("#sortable").sortable({
      update: function( event, ui ) {
        ...
        var jqxhr = $.post("<?php print $this->Html->url(array('controller' => 'co_identifier_assignments',
                                                               'action'     => 'reorder',
                                                               'ext'        => 'json',
  ...
  <table id="provisioning_targets">
    ...
    <tbody id="sortable">
      <?php foreach ($co_identifier_assignments as $c): ?>
        <tr id = "CoIdentifierAssignmentId_<?php print $c['CoIdentifierAssignment']['id']?>" class="line1">
          <td class = "order">
          ...
          <td><?php print $c['CoIdentifierAssignment']['identifier_type']; ?></td>
        </tr>
      <?php endforeach; ?>
    </tbody>
