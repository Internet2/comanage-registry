 ...
 */
  ...
  $this->Html->addCrumb(_txt('op.populate'));
...
<div class="table-container">
  <table id="populate_dictionary_entries" class="ui-widget">
    <tbody>
      <tr class="line1">
        <td>
          <?php
            print $this->Form->create('DictionaryEntry', array('url'  => array('action' => 'populate')));
            
            print $this->Form->hidden('DictionaryEntry.dictionary_id', 
                                      array('default' => filter_var($vv_dict_id,FILTER_SANITIZE_SPECIAL_CHARS)));
            
            print $this->Form->select('DictionaryEntry.file', $vv_available_dictionaries, array('empty' => false));
