<?php
/**
 * COmanage Registry CO Department Index View
 *
 ...
 */
  ...
  $this->Html->addCrumb(_txt('ct.co_departments.pl'));
  ...
  if($permissions['add']) {
    $params['topLinks'][] = $this->Html->link(
      _txt('op.add.new', array(_txt('ct.co_departments.1'))),
      array(
  ...
  <table id="co_departments">
    ...
    <tbody>
      ...
      <tr class="line<?php print ($i % 2)+1; ?>">
        ...
        <td><?php print filter_var($c['CoDepartment']['description'],FILTER_SANITIZE_SPECIAL_CHARS); ?></td>
        <td>
          <?php
            if($permissions['edit']) {
              print $this->Html->link(
