<?php
/**
 * COmanage Registry Standard Cluster (SC) Controller
 *
...
class SCController extends StandardController {
  ...
  public function beforeRender() {
    ...
    if(!empty($this->params->named['clusterid'])) {
      $clusterid = filter_var($this->params->named['authid'],FILTER_SANITIZE_SPECIAL_CHARS);
    } elseif(!empty($this->viewVars[$modelpl][0][$req]['cluster_id'])) {
      $clusterid = $this->viewVars[$modelpl][0][$req]['cluster_id'];
    }
    
    $this->set('vv_clusterid', $clusterid);
  }
