...
class CoMessageTemplate extends AppModel {
  ...
  public function templateSend($id, $toEmail, $substituteWith = array()) {
    ...
    $substitutions = array(
      ...
      'APPROVER_COMMENT'     => $substituteWith['APPROVER_COMMENT'] ?? 'Test approver comment',
      ...
      'CO_PERSON_ID'         => $substituteWith['CO_PERSON_ID'] ?? "1234",
      'ORIG_COU'             => $substituteWith['ORIG_COU'] ?? "Orig COU",
      'NEW_COU'              => $substituteWith['NEW_COU'] ?? "New COU",
      ...
      'SPONSOR_ID'           => $substituteWith['SPONSOR_ID'] ?? "0000",
