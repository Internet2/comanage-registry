<?php 
/* App schema generated on: 2011-07-17 08:02:02 : 1310904122*/
class AppSchema extends CakeSchema {
	...
	var $addresses = array(
		...
		'co_person_role_id' => array('type' => 'integer', 'null' => true),
		'org_identity_id' => array('type' => 'integer', 'null' => true),
		'created' => array('type' => 'datetime', 'null' => true),
		'modified' => array('type' => 'datetime', 'null' => true),
		'indexes' => array('PRIMARY' => array('unique' => true, 'column' => 'id'), 'cm_addresses_i1' => array('unique' => false, 'column' => 'co_person_role_id'), 'cm_addresses_i2' => array('unique' => false, 'column' => 'org_identity_id')),
	...
	var $co_group_members = array(
		...
		'co_person_role_id' => array('type' => 'integer', 'null' => false),
		'member' => array('type' => 'boolean', 'null' => true),
		'owner' => array('type' => 'boolean', 'null' => true),
		'created' => array('type' => 'datetime', 'null' => true),
		'modified' => array('type' => 'datetime', 'null' => true),
		'indexes' => array('PRIMARY' => array('unique' => true, 'column' => 'id'), 'cm_co_group_members_co_group_id_key' => array('unique' => true, 'column' => array('co_group_id', 'co_person_role_id')), 'cm_co_group_members_i1' => array('unique' => false, 'column' => 'co_group_id'), 'cm_co_group_members_i2' => array('unique' => false, 'column' => 'co_person_role_id')),
		'tableParameters' => array()
	);
	var $co_groups = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => NULL, 'length' => 11, 'key' => 'primary'),
	...
	var $co_invites = array(
		...
		'indexes' => array('PRIMARY' => array('unique' => true, 'column' => 'id'), 'cm_co_invites_i1' => array('unique' => false, 'column' => 'co_person_role_id'), 'cm_co_invites_i2' => array('unique' => false, 'column' => 'invitation')),
		'tableParameters' => array()
	);
	var $co_person_roles = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => NULL, 'length' => 11, 'key' => 'primary'),
	...
	var $co_person_sources = array(
		...
		'co_id' => array('type' => 'integer', 'null' => false),
		'co_person_role_id' => array('type' => 'integer', 'null' => false),
		'org_identity_id' => array('type' => 'integer', 'null' => false),
		'created' => array('type' => 'datetime', 'null' => true),
		'modified' => array('type' => 'datetime', 'null' => true),
		'cou_id' => array('type' => 'integer', 'null' => true),
		'indexes' => array('PRIMARY' => array('unique' => true, 'column' => 'id'), 'cm_co_person_sources_i1' => array('unique' => false, 'column' => 'org_identity_id'), 'cm_co_person_sources_i2' => array('unique' => false, 'column' => 'co_id'), 'cm_co_person_sources_i3' => array('unique' => false, 'column' => 'cou_id'), 'cm_co_person_sources_i4' => array('unique' => false, 'column' => 'co_person_role_id')),
		'tableParameters' => array()
	);
	var $cos = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => NULL, 'length' => 11, 'key' => 'primary'),
	...
	var $email_addresses = array(
		...
		'created' => array('type' => 'datetime', 'null' => true),
		'modified' => array('type' => 'datetime', 'null' => true),
		'indexes' => array('PRIMARY' => array('unique' => true, 'column' => 'id'), 'cm_email_addresses_i1' => array('unique' => false, 'column' => 'co_person_role_id'), 'cm_email_addresses_i2' => array('unique' => false, 'column' => 'org_identity_id')),
		'tableParameters' => array()
	);
	...
	var $telephone_numbers = array(
		...
		'modified' => array('type' => 'datetime', 'null' => true),
		'type' => array('type' => 'string', 'null' => true, 'length' => 2),
		'indexes' => array('PRIMARY' => array('unique' => true, 'column' => 'id'), 'cm_telephone_numbers_i1' => array('unique' => false, 'column' => 'co_person_role_id')),
		'tableParameters' => array()
	);
	var $users = array(
