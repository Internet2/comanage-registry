...
$cm_password_authenticator_texts['en_US'] = array(
  ...
  'er.passwordauthenticator.ssrorreminder.multiple'   => 'Could not resolve a single CO Person for "%1$s"',
  'er.passwordauthenticator.ssrorreminder.notfound'   => 'No verified email address was found for "%1$s"',
  ...
  'pl.passwordauthenticator.ssrorreminder.q' => 'Email Address or Identifier',
  'pl.passwordauthenticator.ssrorreminder.sent' => 'An email with further instructions has been sent to the address on record',
  ...
  'pl.passwordauthenticator.usernamereminder' => 'Enable Username Reminder',
  'pl.passwordauthenticator.usernamereminder.desc' => 'Allow Username Reminder sent to a verified email address',
