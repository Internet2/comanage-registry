<?php
/**
 * COmanage Registry CO Self Service Common Widgets Controller
 * 
...
class CoSelfServiceCommonWidgetsController extends SDWController {
  // Class name, used by Cake
  public $name = "CoSelfServiceCommonWidgets";
  
  public $uses = array(
    'SelfServiceCommonWidget.CoSelfServiceCommonWidget',
    'CoPerson'
  );
  ...
  public function display($id) {
    $cfg = $this->CoSelfServiceCommonWidget->getConfig();
  ...
  function isAuthorized() {
    ...
    // Delete an existing CO Self Service Common Widget?
    $p['delete'] = ($roles['cmadmin'] || $roles['coadmin']);
    
    // Edit an existing CO Self Service Common Widget?
    $p['edit'] = ($roles['cmadmin'] || $roles['coadmin']);

    // View an existing CO Self Service Common Widget?
