<?php
/**
 * COmanage Registry Duplicate Account Enroller Plugin Language File
 *
...
$cm_duplicate_account_enroller_texts['en_US'] = array(
  // Titles, per-controller
  'ct.duplicate_account_enrollers.1'               => 'Duplicate Account Enroller',
