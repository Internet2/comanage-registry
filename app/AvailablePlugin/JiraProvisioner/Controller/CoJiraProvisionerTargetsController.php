<?php
/**
 * COmanage Registry CO Jira Provisioner Targets Controller
 *
...
class CoJiraProvisionerTargetsController extends SPTController {
  // Class name, used by Cake
  public $name = "CoJiraProvisionerTargets";
  ...
  function beforeRender() {
    ...
    if(!$this->request->is('restful')) {
      $this->set('vv_identifiers_types', $this->CoJiraProvisionerTarget->CoProvisioningTarget->Co->CoPerson->Identifier->types($this->cur_co['Co']['id'], 'type'));
