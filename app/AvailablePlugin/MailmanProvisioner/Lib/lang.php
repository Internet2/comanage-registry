...
$cm_mailman_provisioner_texts['en_US'] = array(
  ...
  'pl.mailmanprovisioner.info'          => 'The LDAP server must be available and the specified credentials must be valid before this configuration can be saved.',
  ...
  'pl.mailmanprovisioner.rs.sub'        => 'Subscribed to Mailman list (%1$s)',
  'pl.mailmanprovisioner.rs.unsub'      => 'Unsubscribed from Mailman list (%1$s)',
