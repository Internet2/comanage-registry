...
$cm_net_forum_source_texts['en_US'] = array(
  ...
  'pl.netforumsource.querycmts'      => 'Query Committees For Group Mappings',
  'pl.netforumsource.querycmts.desc' => 'If true, query the committee dataset to make available for Group Mappings (Enterprise edition only)',
  'pl.netforumsource.queryevents'    => 'Query Events For Group Mappings',
  'pl.netforumsource.queryevents.desc' => 'If true, query the events dataset to make available for Group Mappings (Pro edition only)',
