  ...
  const app = Vue.createApp({
    data() {
      return {
        ...
        txt: {
          add:                 "<?php print _txt('pl.op.eligibilitywidget.membership.add'); ?>",
          addItem:             "<?php print _txt('pl.op.eligibilitywidget.membership.add'); ?>",
          ...
          edit :               "<?php print _txt('pl.op.eligibilitywidget.membership.add'); ?>",
