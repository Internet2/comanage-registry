...
$cm_email_address_widget_texts['en_US'] = array(
  ...
  'pl.emailaddresswidget.fd.type.primary'               => 'Primary Email Address Type',
  'pl.emailaddresswidget.fd.type.primary.desc'          => 'Email Addresses marked as "Primary" in this widget will be assigned this type. The widget will allow only one address to have this type, and any addess previously marked Primary will be changed to use the Default Email Address Type above.',
